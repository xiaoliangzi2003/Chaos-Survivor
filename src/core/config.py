...
COLOR_GOLD        = GOLD
COLOR_UI_BG       = (15,  15,  25, 210)   # RGBA（含透明度）
...
# ── 波次配置 ──────────────────────────────────────────
TOTAL_WAVES         = 20
WAVE_BASE_DURATION  = 30        # 秒
WAVE_DURATION_INC   = 0.5       # 每波额外秒数
WAVE_BREAK_DURATION = 3.0       # 波次间隔秒数
BOSS_WAVES          = {5, 10, 15, 20}
ELITE_WAVE_INTERVAL = 3         # 每 N 波出现精英
