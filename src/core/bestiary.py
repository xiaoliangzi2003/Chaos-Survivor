...
BESTIARY_ENTRIES: tuple[BestiaryEntry, ...] = (
    BestiaryEntry("zombie", "腐化行尸", "小怪", "近战压迫", "最基础的近战敌人，移动慢但比较耐打，会持续向玩家逼近。", "利用走位和范围武器边退边清，不要被数量包住。"),
    BestiaryEntry("speeder", "疾行猎犬", "小怪", "高速突进", "会蓄力后突然加速冲脸，适合混在怪潮里打乱节奏。", "看到它准备冲刺时横向拉开，不要直线后撤。"),
    BestiaryEntry("lancer", "突刺枪兵", "小怪", "直线穿刺", "会朝玩家方向猛冲，瞬时爆发比普通近战更高。", "保持斜向移动，让它扑空后再回头输出。"),
    BestiaryEntry("wisp", "寒辉幽灵", "小怪", "远程风筝", "会与玩家保持距离并持续发射弹幕。", "优先处理，避免远程弹幕在场上越积越多。"),
